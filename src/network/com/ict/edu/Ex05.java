...
public class Ex05 {
	public static void main(String[] args) {
		  ...
		  try {
			...
			// jsonparser에 json 데이터를 넣어 파싱한 다음 jsonobject로 변환 한다.
			...
			for(int i = 0; i < personArray.size(); i++) {
				...
				System.out.println(person_obj.get("name")+"\t");
				System.out.println(person_obj.get("age")+"\t");
			...
			for(int i= 0; i< BooksArray.size();i++) {
				...
				System.out.println(book_obj.get("name")+"\t");
