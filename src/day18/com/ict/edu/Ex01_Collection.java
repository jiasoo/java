...
public class Ex01_Collection {
	// 제네릭과 컬렉셔(자료구조)
	// 제네릭 : 컬렉션 어떤 객체들로 이루어 졌는지를 표시하는 객체(클래스) 타입
	// 컬렉션 : 객체들을 모아서 관리하는 인터페이스드를 말한다.
	...
	// inEmpty() : boolean<E> => 해당 컬렉션이 비어있으면 true
	// interator() : Inerator<E>=> 컬렉션안에 존재하는 객체들을 순서대로 접근하기 위해서
	// Inerator 객체를 반호나
	// 요소들을 하나씩 꺼내서 작업 할때 사용 (for문더 사용 가능)
