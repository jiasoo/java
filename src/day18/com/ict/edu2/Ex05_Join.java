...
public class Ex05_Join extends JFrame{
	public Ex05_Join() {
		...
		JPanel jp1 = new JPanel(new FlowLayout(FlowLayout.LEFT));//왼쪽정렬 
		JTextField name = new JTextField(10);
		JRadioButton man = new JRadioButton("남");
		JRadioButton women = new JRadioButton("여");
		...
		JPanel jp2 = new JPanel(new FlowLayout(FlowLayout.LEFT));//왼쪽정렬
		JTextField birth = new JTextField(10);
		
		jp2.add(new JLabel(" 생년월일 : "));
		jp2.add(birth);
		
		JPanel jp3 = new JPanel(new FlowLayout(FlowLayout.LEFT));//왼쪽정렬
